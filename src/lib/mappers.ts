...
export function toRecipeForMatch(
  ...
  return {
    ...
    foodCategories: parseStringArray(recipe.foodCategories),
    ...
    carnivoreEligible: Boolean(recipe.carnivoreEligible),
    atkinsEligible: Boolean(recipe.atkinsEligible),
    lowCarbEligible: Boolean(recipe.lowCarbEligible),
