...
async function main() {
  ...
  const recipes = [
    ...
    {
      title: "Uncle Roger Egg Fried Rice",
      description:
        "Haiyaa-energy wok rice: cold grains, eggs scrambled in, spring onion, and a soy-MSG finish. Proven crowd-pleaser energy.",
      costTier: "cheap",
      tags: j(["rice", "egg", "dinner", "variant", "wok"]),
      servings: 2,
      cookTimeMinutes: 15,
      isStruggleMeal: false,
      techniqueTips: j([
        "Use day-old rice — wet rice is disgraceful.",
        "Scramble eggs first, push aside, then fry aromatics and rice.",
      ]),
      flavorBoosters: j(["soy sauce", "sesame oil", "spring onion", "white pepper"]),
      steps: j([
        "Beat eggs with a pinch of salt. Scramble quickly in hot oil; set aside.",
        "Fry minced garlic and white parts of spring onion until fragrant.",
        "Add cold rice; break clumps and toss until hot and a little toasty.",
        "Season with soy sauce and white pepper; fold eggs back in.",
        "Finish with sesame oil and green onion. Serve immediately.",
      ]),
      ingredients: [
        { name: "White rice", quantity: 2, unit: "cups" },
        { name: "Eggs", quantity: 2, unit: "each" },
        { name: "Garlic", quantity: 2, unit: "cloves" },
        { name: "Spring onion", quantity: 2, unit: "each" },
    ...
    {
      title: "Wok Hei Vegetable Fried Rice",
      description:
        "Classic vegetable fried rice with smoky wok breath — peas, carrot, and a light soy glaze. The established weeknight standard.",
      costTier: "cheap",
      tags: j(["rice", "vegetable", "dinner", "variant", "classic"]),
      servings: 3,
      cookTimeMinutes: 20,
      isStruggleMeal: false,
      techniqueTips: j([
        "High heat and a roomy pan (or wok) for real wok hei.",
        "Add soy off the direct flame so it doesn't burn bitter.",
      ]),
      flavorBoosters: j(["soy sauce", "garlic", "ginger", "sesame oil"]),
      steps: j([
        "Dice carrot and mince garlic and ginger. Heat oil until shimmering.",
        "Stir-fry carrot and peas 1–2 minutes; add garlic and ginger.",
        "Add cold rice; toss hard until grains separate and pick up color.",
        "Season with soy sauce; finish with sesame oil and white pepper.",
        "Taste, adjust salt, and serve hot.",
      ]),
      ingredients: [
        { name: "White rice", quantity: 3, unit: "cups" },
        { name: "Carrots", quantity: 1, unit: "each" },
        { name: "Frozen peas", quantity: 0.5, unit: "cups" },
        { name: "Garlic", quantity: 2, unit: "cloves" },
        { name: "Ginger", quantity: 1, unit: "tsp", optional: true },
        { name: "Soy sauce", quantity: 2, unit: "tbsp" },
        { name: "Vegetable oil", quantity: 2, unit: "tbsp" },
        { name: "Sesame oil", quantity: 1, unit: "tsp", optional: true },
      ],
