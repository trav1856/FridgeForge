...
async function main() {
  ...
  const pantry = [
    ...
    { name: "Dry black beans", quantity: 2, unit: "cups", category: "Proteins", tags: j(["staple", "struggle"]) },
    { name: "Eggs", quantity: 12, unit: "each", category: "Proteins", tags: j(["staple", "struggle"]) },
    { name: "Spaghetti", quantity: 1, unit: "lb", category: "Grains", tags: j(["staple", "struggle"]) },
    { name: "Canned diced tomatoes", quantity: 3, unit: "cans", category: "Canned", tags: j(["staple"]) },
